...
> 🔀 **这是 [`LessXi`](https://github.com/LessXi) 的 fork**：上游是 [`WestFox-AwA/dsh-prompt-optimizer`](https://github.com/WestFox-AwA/dsh-prompt-optimizer) 的 `v0.1.1-beta.1`（BSD-3-Clause），已改名为 **`@lessxi/dsh-prompt-optimizer`**（当前 **0.4.29**），以便与上游并行安装、独立迭代。
>
...
本 fork：**[LessXi](https://github.com/LessXi)** · 当前版本 **0.4.29**（插件内 `?` 面板最底部也保留上游署名）
