		...
		exports.apply = function apply(ctx) {
			...
			own(() => {
				...
				style.textContent = [
					...
					".dpo-model-caret{flex:0 0 auto;font-size:9px;opacity:.6;transition:transform .12s ease}",
					...
					/* 模型弹层 */
					".dpo-pop{width:272px;padding:8px;border-radius:14px;border:1px solid color-mix(in srgb,var(--dpo-line) 80%,transparent);box-shadow:var(--dpo-shadow-2);animation:dpo-pop-in .24s var(--dpo-ease);transform-origin:bottom left;scrollbar-gutter:stable}",
					...
					".dpo-pop-item{position:relative;display:flex;align-items:center;gap:8px;padding:6px 10px;border-radius:9px;font-size:12px;transition:background .18s var(--dpo-ease),color .18s var(--dpo-ease),padding-left .18s var(--dpo-ease),box-shadow .18s var(--dpo-ease);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}",
