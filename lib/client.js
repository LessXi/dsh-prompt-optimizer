			...
			own(() => {
				...
				style.textContent = [
					...
					"@media (max-width:1240px){.dpo-slider-track{flex-basis:88px;min-width:76px}.dpo-model{max-width:112px}.dpo-slider-value{font-size:12px}.dpo-controls{gap:9px}}",
										".dpo-notice{flex:0 0 auto;font-size:11px;padding:2px 8px;border-radius:10px;background:rgba(74,158,255,.15);color:var(--dsw-alias-state-business-primary,#4a9eff);white-space:nowrap}",
					...
					".dpo-btn.danger{flex:1;border-radius:8px;border:1px solid #d9534f;background:#d9534f;color:#fff;font-size:11px;cursor:pointer}",
					".dpo-btn.primary{flex:1;border-radius:8px;border:1px solid var(--dsw-alias-state-business-primary,#4a9eff);background:var(--dsw-alias-state-business-primary,#4a9eff);color:#fff;font-size:11px;cursor:pointer}",
