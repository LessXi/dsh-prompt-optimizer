		...
		exports.apply = function apply(ctx) {
			...
			own(() => {
				...
				style.textContent = [
					...
					".dpo-switch-track{position:relative;width:32px;height:18px;border-radius:9px;background:var(--dsw-alias-interactive-bg-hover);transition:background .15s ease;flex:0 0 auto}",
					".dpo-switch-knob{position:absolute;top:2px;left:2px;width:14px;height:14px;border-radius:50%;background:var(--dsw-alias-label-secondary);box-shadow:0 1px 2px rgba(0,0,0,.25);transition:transform .15s ease,background .15s ease}",
