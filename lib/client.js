		...
		exports.apply = function apply(ctx) {
			...
			own(() => {
				...
				style.textContent = [
					...
					".dpo-pop-priv{display:flex;align-items:center;gap:8px;padding:8px 12px 10px;border-top:.5px solid var(--dsw-alias-border-l2);flex-wrap:wrap}",
					...
					".dpo-switch-knob{position:absolute;top:2px;left:2px;width:14px;height:14px;border-radius:50%;background:var(--dsw-alias-bg-l0,#fff);box-shadow:0 1px 2px rgba(0,0,0,.25);transition:transform .15s ease}",
					".dpo-switch[data-on=\"true\"] .dpo-switch-track{background:var(--dsw-alias-label-primary)}",
					".dpo-switch[data-on=\"true\"] .dpo-switch-knob{transform:translateX(14px)}",
