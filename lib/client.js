window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function tierPopover() {
			...
			const HINT = { off: "原样发出，不拦截", basic: "快速润色，约 3 秒", advanced: "优化更完整，约 20 秒", extreme: "反复查证，约 20 秒以上" };
			return h("div", {
				...
				h("div", { className: "dpo-pop-group" },
					...
					}, t.label, h("span", { className: "dpo-pop-chip-quiet" }, HINT[t.id] || ""))),
				),
				h("div", { className: "dpo-pop-foot" },
		...
		function permPopover() {
			...
			const HINT = { review: "停在浮窗，等你确认再发出", auto: "优化完直接替你把消息发出" };
			return h("div", {
				...
				h("div", { className: "dpo-pop-group" },
					...
					}, p.label, h("span", { className: "dpo-pop-chip-quiet" }, HINT[p.id] || ""))),
				),
				h("div", { className: "dpo-pop-foot" },
		...
		function Controls(props) {
			...
			return h("div", { ref: nodeRef, className: "dpo-controls", "data-dpo": "controls" },
						...
						"data-open": String(store.tierPopOpen === true),
				...
				h("button", {
					...
					"data-open": String(store.permPopOpen === true),
					"data-off": String(off),
		...
		exports.apply = function apply(ctx) {
			...
			own(() => {
				...
				style.textContent = [
					...
					"/* ── 1) --dsw-alias-bg-l1 在 DSH 的设计 token 中并不存在（正确名为 --dsw-alias-bg-layer-1），",
